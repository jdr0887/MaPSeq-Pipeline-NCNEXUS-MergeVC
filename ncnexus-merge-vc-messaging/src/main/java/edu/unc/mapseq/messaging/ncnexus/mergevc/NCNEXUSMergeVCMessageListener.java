...
public class NCNEXUSMergeVCMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSMergeVCMessageListener.class);

    public NCNEXUSMergeVCMessageListener() {
        super();
    }
