...
public class MessageTest {
    ...
    public void testCAVASAQueue() {
        ...
        try {
            ...
            Destination destination = session.createQueue("queue/ncnexus.mergevc");
            ...
            List<Long> idList = Arrays.asList(87443L, 87444L, 87445L, 87446L, 138601L, 138627L, 645578L, 1187302L, 1188124L);
