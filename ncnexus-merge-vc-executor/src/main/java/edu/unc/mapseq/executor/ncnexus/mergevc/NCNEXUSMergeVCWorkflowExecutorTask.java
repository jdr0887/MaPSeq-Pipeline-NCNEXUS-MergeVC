...
import edu.unc.mapseq.workflow.ncnexus.mergevc.NCNEXUSMergeVCWorkflow;

public class NCNEXUSMergeVCWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSMergeVCWorkflowExecutorTask.class);
    ...
    public NCNEXUSMergeVCWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    NCNEXUSMergeVCWorkflow ncnexusMergeBAMWorkflow = new NCNEXUSMergeVCWorkflow();
